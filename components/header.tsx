...
export default function Header() {
  ...
  return (
    <header className="w-full px-4 sm:px-6 py-3 sm:py-4 flex justify-between items-center text-white relative z-10">
      <Link href="/">
        <Logo className="size-15 md:size-20" />
      </Link>

      <div className="relative items-center flex-col">
        <div className="hidden md:block text-md font-bold">
          Department
        </div>
        ...
        >
          <span className="text-base sm:text-lg font-medium mr-1 sm:mr-[3px]">
            {dept === "" ? "Select" : dept}
          </span>
          ...
          >
            <path
              fillRule="evenodd"
              d="M5.22 8.22a.75.75 0 0 1 1.06 0L10 11.94l3.72-3.72a.75.75 0 1 1 1.06 1.06l1.06-1.06a.75.75 0 0 1-1.06-1.06l-4.25 4.25a.75.75 0 0 1-1.06 0L5.22 9.28a.75.75 0 0 1 0-1.06Z"
              clipRule="evenodd"
            />
          </svg>
        </button>
