...
export default function SchemeSyllabusPage() {
  ...
  const syllabusLinks: {
    ...
    '2020': {
      cse: {
        '1-2':
          'https://drive.google.com/open?id=1jyZmct_kuXDCyrDVubaa5THRSIbt6W_f',
        '3':
          'https://drive.google.com/open?id=1fRSBNsS0eNLLK6-pWF9V7tKaAGAyAvlx',
        '4':
          'https://drive.google.com/open?id=1vEPJhUXnfoCW3hpv6YceodsXoIt14OY6',
        '5':
          'https://drive.google.com/open?id=1FSzkSznP32sJcP72z1JZ7NesT14wVGMB',
        '6':
          'https://drive.google.com/open?id=17XfHsOHmCG0n8EUduUejSYmglkUNJWAm',
        '7':
          'https://drive.google.com/open?id=1U7iOz8n0U0HM7gix1kry6Znsoowx4se2',
        '8':
          'https://drive.google.com/open?id=1p2gW1XhPJQYr-8TY-eMzcKro8gZTan-G',
      },

      ece: {
        '1-2':
          'https://drive.google.com/open?id=1ne-63gkQYtBel5CPfAGTmik36mHczGEQ',
        '3':
          'https://drive.google.com/open?id=1lK0gNtnfRFsvJbM7KJmt2xVUG2tl0fnY',
        '4':
          'https://drive.google.com/open?id=1q4giFeYed16PNZ26VLoCDBWScE-3sIPg',
        '5':
          'https://drive.google.com/open?id=1WwXOpcz_GGhBwolaIUhbdFHEspzaM2ZV',
        '6':
          'https://drive.google.com/open?id=1xQc-4Rs79CayzXyQQ4KVP5r4pKQIJZMR',
        '7':
          'https://drive.google.com/open?id=14EgfEOfU8CQ9myRXHaWSGKZSsJtl7mUF',
        '8':
          'https://drive.google.com/open?id=1m1FrEeDfDXpRSfspERR_QKaz2HnHNG_1',
      },

      it: {
        '1-2':
          'https://drive.google.com/open?id=1qiX0A8my5lFcaCuUgLYN5hmHfnNadu9J',
        '3':
          'https://drive.google.com/open?id=1G7kIYZ9yV9jkQAmqOAeBDn287kf5ioTk',
        '4':
          'https://drive.google.com/open?id=1vHPs1MTLP0MY7veAEUn_IofB-JqZ7eJE',
        '5':
          'https://drive.google.com/open?id=1luMrf5w34FWw19w7zKOfnEuzbAVBU20o',
        '6':
          'https://drive.google.com/open?id=1gu3laCU3ewFh5J7OOj0VwK7l2HvYJ8_U',
        '7':
          'https://drive.google.com/open?id=1Iwp8UPnMSLqAlZzs19rQOQJMA8xqYO-5',
        '8':
          'https://drive.google.com/open?id=1JuE9sDtUxQv3R_BwrepzQqmBOCo_jO9U',
      },
    },
